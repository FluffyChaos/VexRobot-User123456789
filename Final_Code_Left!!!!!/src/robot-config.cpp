...
motor WestMotor = motor(PORT1, ratio18_1, false);
motor EastMotor = motor(PORT2, ratio18_1, true);
...
distance Distance_y = distance(PORT14);
distance Distance_x = distance(PORT20);
motor Ramp1 = motor(PORT11, ratio36_1, false);
